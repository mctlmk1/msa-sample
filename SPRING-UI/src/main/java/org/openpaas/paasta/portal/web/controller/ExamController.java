...
public class ExamController {
	...
	@GetMapping(value = {"/zuul/cpClusterLog/list"})
	public Map zuulGetCPClusterLogList(HttpServletRequest request) {

		ExamController.LOGGER.info("zuulGetCPClusterLogList start");
		Map rs = this.examService.eurekaRest("CLOUDAPITWO/cpClusterLog/list", HttpMethod.GET, null);
		return rs;
	}
